...
<?php
    if(isset($_POST['register'])){
        ...
        $query = "INSERT INTO users (username, user_email, user_password, user_role) VALUES ('{$username}', '{$email}', '{$pasword_hash}', 'subscriber')";
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="" method="POST">
                            <div class="mb-3">
                                <p class="text-primary"><em><?php echo $message ?></em></p>
                                <div style="padding:15px; color:#F00;"></div>
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" name="register" type="submit">Register</button>
                            </div>
                        </form>
                        <p class="text-center">
